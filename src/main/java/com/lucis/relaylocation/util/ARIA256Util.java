...
public class ARIA256Util {
    ...
    private static String ariaKeyGenerator;

    @Value(value = "${relay-location.aria.key.generator}")
    public void setAriaKeyGenerator(String ariaKeyGenerator) {
        this.ariaKeyGenerator = ariaKeyGenerator;
    }
    ...
    private static int[] m_MasterKey = new int[32];

	/*public ARIA256Util(String key) {
		CreateMasterKey(key);
	}*/

    private static void DL(int[] i, int[] o) {
        int T;
    ...
    private static void DL(int[] i, int iIndex, int[] o, int oIndex) {
        int T;
    ...
    // string t
    private static void RotXOR(int[] s, int n, int[] t, int index) {
        int i, q;
    ...
    private static void ConvertIntArray(byte[] b, int[] n) {
    ...
    private static void ConvertIntArray(int[] n) {
    ...
    private static void ConvertByteArray(int[] n, byte[] b) {
        for (int j = 0; j < n.length; j++) {
            b[j] = (byte) n[j];
        }
    }
    ...
    private static int EncKeySetup(int[] w0, int[] e, int keyBits) {
    ...
    private static int DecKeySetup(int[] w0, int[] d, int keyBits) {
        int i, j, R;
        int[] t = new int[16];
    ...
    private static void Crypt(int[] p, int R, int[] e, int[] c) {
        int i, j;
        int index = 0;
        int[] t = new int[16];
    ...
    private static void Crypt(int[] p, int pIndex, int R, int[] e, int[] c) {
        int i, j;
        int index = 0;
        int[] t = new int[16];
    ...
    private static String ToHex(byte[] bin_data) {
    ...
    private static byte[] ToHex(String strHex) {
    ...
    @PostConstruct
    public static Boolean CreateMasterKey() {
        int nSize = ariaKeyGenerator.length();
        ...
        byte[] StrByte;
        try {
            StrByte = ariaKeyGenerator.getBytes("EUC-KR");
